   ...
   return (
      <>
         <div class="text-center p-10">
            <h1 class="font-bold text-4xl mb-4 ">List Products</h1>
         </div>
         <a
                  ...
                  <div class="overflow-x-auto w-full  border rounded-lg border-gray-300">
                     <table class="w-full rounded-xl">
                        <thead>
                           <tr class="bg-gray-50">
                              <th class="">
                                 <div class="flex items-center py-5 px-5 "></div>
                              </th>
                              <th
                                 scope="col"
                        ...
                        <tbody class="divide-y divide-gray-300 ">
                           {data.map((item) => (
                              <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                 ...
                                 <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 overflow-hidden text-ellipsis max-w-48">
                                    {item.title}
                                 </td>
                                 ...
                                 <td class=" px-5 py-3">
                                    <div class="whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                       <img
                                 ...
                                 <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div class="flex justify-center w-20 items-center gap-1">
                                       {item.category}
                                    </div>
                                 </td>
